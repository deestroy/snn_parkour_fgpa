...
module tb_conv_p;
    ...
    initial begin
        ...
        if (fails == 0)
            $display("TB_PASS %0d comparisons bit-identical over %0d samples x %0d timesteps, %0d engine cycles/sample (P=%0d)",
                     checked, nsamples, T, cyc_total / nsamples, P);
        else
